...
class Situation
{
     ...
     * Default constructor
     */
    public function __construct($id,$nom,$date_debut,$details,$date_creation,$duree,$type_duree,$id_user)
    {
        $this->_id=$id;
        $this->_nom=$nom;
    ...
    public function setid_user(string $newId_duree)
    { 
        $this->_id_user=$newId_duree;
    }
