...
<html lang="fr">
    ...
    <body>
        ...
        <?php require("leftmenu.php") ?>
            <div class="rightmenu">
                <main>
                    <form method='post' action='../c/realisation.php'>
                    ...
                    <h2>Accès aux éléments justificatifs</h2>
                    <div class="rightsubtitle">
                        <div>
                    ...
                    <div class="rightsubtitle">
                        ...
                        <SELECT name='competence'>
                            <?php while ($donnees = $req_comp->fetch()) {
                                echo "<option value='" . $donnees['id_competence'] . "'>" . $donnees['identifiant']. '-' . $donnees['nom']  ."</option>"; 
                            }?>
                        </SELECT>
                        <div>
